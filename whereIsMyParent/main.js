...
function findChildren(ppl) {
    return [...ppl].sort((a, b) => a.localeCompare(b, 'en-US', {caseFirst: 'upper'})).join('');
}

console.log(findChildren('aaaccbbAccCBbbb'))//should log 'AaaaBbbbbbCcccc'
